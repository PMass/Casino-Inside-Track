...
function Utils:HandleControls()
    Citizen.CreateThread(function()
        while self.InsideTrackActive do
            ...
            if IsControlJustPressed(2, 200) then
                LeaveInsideTrack()
            ...
            if IsControlJustPressed(2, 237) then
                ...
                if (clickedButton == 10) then
                    ...
                    TriggerServerEvent("casino:server:removeChips", self.CurrentBet)
                ...
                while checkRaceStatus do
                    ...
                    if (raceFinished) then 
                        ...
                        print("Bet on horse", self.CurrentHorse)
                        print("winning Horse", self.CurrentWinner)
                        print("Bet", self.CurrentBet)
                        print("Gain", self.CurrentGain)


                        if (self.CurrentHorse == self.CurrentWinner) then
                            TriggerServerEvent("casino:server:giveChips", self.CurrentGain)
                        end
